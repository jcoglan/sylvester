<?php $title = 'API Documentation - Matrix'; ?>
...
<p>The <code>Matrix</code> class is designed to model real matrices in any number of dimensions. All the elements in a matrix must be real numbers.</p>

<h3>Class methods</h3>

<a name="create"></a>
<h3 class="method">Matrix.create(<span class="arg">elements</span>) <span class="version">0.1.0</span></h3>
<p>Creates and returns a new <code>Matrix</code> instance from the array <code>elements</code>. <code>elements</code> should be a nested array: the top level array is the rows, and each row is an array of elements. This means you write out a matrix in code in the same orientation you would on paper.</p>
...
<p>Every row must have the same number of elements, otherwise the method will return <code>null</code>.</p>
...
<p>Returns a square matrix whose leading-diagonal elements are the values in the array <code>elements</code>, and whose off-diagonal elements are zero.</p>
...
<p>Returns a matrix with <code>n</code> rows and <code>m</code> columns, all the elements of which are random numbers between 0 and 1.</p>

<a name="rotation"></a>
<h3 class="method">Matrix.Rotation(<span class="arg">angle</span> [, <span class="arg">axis</span>]) <span class="version">0.1.0</span></h3>
<p>If called with only one argument, returns the 2&times;2 matrix for an anticlockwise rotation of <code>angle</code> radians about the origin. That is, vectors are rotated anticlockwise with respect to the coordinate system, not the other way round.</p>
<p>If called with two arguments, returns the 3&times;3 matrix for a right-handed rotation of <code>angle</code> radians about the axis given by the 3-vector <code>axis</code>, keeping the origin fixed.</p>
...
<p>Each of these return the 3&times;3 matrix representing a right-handed rotation of points in 3-dimensional space relative to the coordinate system through an angle of <code>angle</code> radians about the <span class="math">x</span>, <span class="math">y</span> and <span class="math">z</span> axes respectively. They are used as a foundation for the more general <a href="#rotation"><code>Matrix.Rotation</code></a>.</p>

<a name="zero"></a>
<h3 class="method">Matrix.Zero(<span class="arg">n</span>, <span class="arg">m</span>) <span class="version">0.1.0</span></h3>
<p>Returns a matrix with <code>n</code> rows and <code>m</code> columns, all the elements of which are zero.</p>

<h3>Instance methods</h3>

<a name="add"></a>
<h3 class="method">add(<span class="arg">matrix</span>) <span class="version">0.1.0</span></h3>
<p>Returns the matrix sum of the receiver and <code>matrix</code>. Thus, <code>A.add(B)</code> is equivalent to <span class="math"><b>A</b> + <b>B</b></span>. Returns <code>null</code> if the matrices are different sizes.</p>

<a name="augment"></a>
<h3 class="method">augment(<span class="arg">matrix</span>) <span class="version">0.1.0</span></h3>
<p>Returns the result of augmenting the receiver with <code>matrix</code>, that is, appending <code>matrix</code> to the right hand side of the receiver. Both matrices must have the same number of rows for this to work.</p>
...
<p><code>matrix</code> can also be a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>, as long as it has the same number of elements as the receiver has rows. It will be appended to the receiver as an extra column on the right hand side.</p>
...
<p><code>A.canMultiplyFromLeft(B)</code> returns <code>true</code> iff <b class="math">AB</b> is a mathematically valid expression. This is the case iff <b class="math">A</b> has the same number of columns as <b class="math">B</b> has rows. <code>matrix</code> can also be a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>, as long as it has the same number of elements as the receiver has rows.</p>

<a name="col"></a>
<h3 class="method">col(<span class="arg">j</span>) <span class="version">0.1.0</span></h3>
<p>Returns the <code>j</code>th column of the receiver as a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>.</p>
...
<p>If the receiver is square, returns its determinant, otherwise returns <code>null</code>. Note that if the receiver is singular, this method will return exactly zero, with no rounding errors.</p>

<a name="diagonal"></a>
<h3 class="method">diagonal() <span class="version">0.1.0</span></h3>
<p>If the receiver is square, returns its leading-diagonal elements as a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>. Otherwise, returns <code>null</code>.</p>
...
<p><code>A.e(i,j)</code> returns the element <span class="math"><i>A<sub>ij</sub></i></span> of matrix <b class="math">A</b>, that is the element in the <code>i</code>th row and <code>j</code>th column. Indexes begin at 1, in agreement with mathematical notation.</p>

<a name="eql"></a>
<h3 class="method">eql(<span class="arg">matrix</span>) <span class="version">0.1.0</span></h3>
<p>Returns <code>true</code> iff <code>matrix</code> has all its elements equal to those of the receiver.</p>

<a name="indexof"></a>
<h3 class="method">indexOf(<span class="arg">x</span>) <span class="version">0.1.0</span></h3>
<p>Reads the receiver&rsquo;s elements row by row from left to right and returns an object containing the indeces of the first exact match. Returns <code>null</code> if no match is found.</p>
...
<p>Returns the matrix inverse of the receiver, if one exists. If the matrix is singular or not square, then <code>null</code> is returned. The inverse is computed using <a href="http://mathworld.wolfram.com/Gauss-JordanElimination.html">Gauss-Jordan elimination</a>.</p>

<a name="issamesizeas"></a>
<h3 class="method">isSameSizeAs(<span class="arg">matrix</span>) <span class="version">0.1.0</span></h3>
<p>Returns <code>true</code> iff <code>matrix</code> has the same number of rows and columns as the receiver. <code>matrix</code> can also be a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>, as long as it has the same number of elements as the receiver has rows.</p>

<a name="issingular"></a>
<h3 class="method">isSingular() <span class="version">0.1.0</span></h3>
<p>Returns <code>true</code> iff the receiver is square and has zero determinant.</p>
...
<p>Maps the receiver to another matrix by calling <code>iterator</code> on each element of the receiver in turn. <code>iterator</code> receives the row and column index of each element as second and third arguments. Some examples:</p>
...
<p>Returns the value of the element of the receiver with the largest absolute value.</p>
...
<p>This method returns a matrix formed from a subset of the receiver&rsquo;s elements. It selects elements beginning at row <code>i</code> and column <code>j</code> of the receiver, and returns a matrix with <code>n</code> rows and <code>m</code> columns. The selection wraps to the other side of the receiver if <code>n</code> or <code>m</code> is large enough. This is best illustrated by example:</p>
...
<p>If <code>object</code> is a matrix, then this method returns the result of multiplying the receiver by <code>object</code> in that order: <code>A.multiply(B)</code> means <b class="math">AB</b>. If <code>object</code> is a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>, then it is converted to a column matrix, multiplied by the receiver, and the result is returned as a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a> (this saves you having to call <code>col(1)</code> on the result). If <code>object</code> is a scalar, then the method returns a copy of the receiver with all its elements multiplied by <code>object</code>.</p>

<p>This method is aliased as <a href="#x"><code>x</code></a>.</p>

<a name="rank"></a>
<h3 class="method">rank() <span class="version">0.1.0</span></h3>
<p>Returns the receiver&rsquo;s rank, which is the number of linearly independent rows/columns it contains.</p>
...
<p>Returns the <code>i</code>th row of the receiver as a <a href="<?php echo ROOT.'/api/vector'; ?>"><code>Vector</code></a>.</p>
...
<p>Sets the receiver&rsquo;s elements from the array <code>elements</code>. The element array&rsquo; top-level elements should be the rows, and each row is an array of values reading from left to right across the columns. See <a href="#create"><code>Matrix.create</code></a>.</p>

<a name="snapto"></a>
<h3 class="method">snapTo(<span class="arg">x</span>) <span class="version">0.1.0</span></h3>
<p>Returns a copy of the receiver in which any elements that differ from <code>x</code> by less than the value of <code>Sylvester.precision</code> are set exactly equal to <code>x</code>.</p>

<a name="subtract"></a>
<h3 class="method">subtract(<span class="arg">matrix</span>) <span class="version">0.1.0</span></h3>
<p>Returns the result of subtracting <code>matrix</code> from the receiver. Thus, <code>A.subtract(B)</code> is equivalent to <span class="math"><b>A</b> &minus; <b>B</b></span>. Returns <code>null</code> if the matrices are different sizes.</p>

<a name="torighttriangular"></a>
<h3 class="method">toRightTriangular() <span class="version">0.1.0</span></h3>
<p>Returns a copy of the receiver converted to <a href="http://en.wikipedia.org/wiki/Triangular_matrix">right triangular form</a>. The conversion is done only by adding multiples of rows to other rows, so the determinant (if the matrix is square) is unchanged. This method can be used on non-square matrices, which lets you use it to solve sets of simultaneous equations. For example: solving the system of linear equations</p>
...
<p>Returns the trace for square matrices, which is the sum of their leading-diagonal elements.</p>
